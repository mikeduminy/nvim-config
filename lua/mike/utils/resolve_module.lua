local fileUtils = require 'mike.utils.file'
local resolve_lua_module = require 'mike.utils.resolve_lua_module'
local resolve_node_module = require 'mike.utils.resolve_node_module'
...
return function(file_name)
  local current_file = fileUtils.get_current_file()
